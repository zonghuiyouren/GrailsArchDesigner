...
<html>
    ...
    <body>
        ...
        <div id="show-alternative" class="content scaffold-show" role="main">
            ...
            <f:display bean="alternative" />
            <g:form resource="${this.alternative}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.alternative}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
