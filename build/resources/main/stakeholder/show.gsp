...
<html>
    ...
    <body>
        ...
        <div id="show-stakeholder" class="content scaffold-show" role="main">
            ...
            <f:display bean="stakeholder" />
            <g:form resource="${this.stakeholder}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.stakeholder}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
