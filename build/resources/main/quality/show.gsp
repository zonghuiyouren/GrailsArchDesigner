...
<html>
    ...
    <body>
        ...
        <div id="show-quality" class="content scaffold-show" role="main">
            ...
            <f:display bean="quality" />
            <g:form resource="${this.quality}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.quality}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
