...
<html>
    ...
    <body>
        ...
        <div id="show-decision" class="content scaffold-show" role="main">
            ...
            <f:display bean="decision" />
            <g:form resource="${this.decision}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.decision}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
